    ...
    <body>
        ...
        <div class="bg-image d-flex flex-column justify-content-center" style="background-image: url('../../pics/claquete.jpg'); height: 100vh; background-size: cover;">
            <div class="container-sm d-flex flex-column justify-content-center w-50">
                ...
                <h1 class="text-center text-light fw-bolder">Excluir DVD</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="text-light fw-bolder">${requestScope.dvd.titulo}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="text-light fw-bolder">Data de Lançamento:</td>
                                ...
                                <tr>
                                    <td class="text-light fw-bolder">Gênero:</td>
