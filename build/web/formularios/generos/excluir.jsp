    ...
    <body>
        ...
        <div class="bg-image d-flex flex-column justify-content-center" style="background-image: url('../../pics/claquete.jpg'); height: 100vh; background-size: cover;">
            <div class="container-sm d-flex flex-column justify-content-center w-50">
                ...
                <h1 class="text-center text-light fw-bolder">Excluir Gênero</h1>
                        ...
                        <div class="mb-3">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="text-light fw-bolder">${requestScope.genero.descricao}</td>
                                </tr>
                            </table><br/>
                                    
                            <input class ="btn btn-light" type="submit" value="Excluir"/> 
                            <a class="btn btn-light" href="${cp}/formularios/generos/listagem.jsp" role="button">Voltar</a>
